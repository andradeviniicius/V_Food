...
import foodieLandLogo from "assets/foodielandLogo.svg";
  ...
  return (
    <footer className="mainFooter">
      <div className="mainFooter__content">
        <div className="mainFooter__topContainer">
          <div className="mainFooter__header">
            <Link className="mainFooter__logo" to={'/'}>
              <img className="mainFooter__logo" src={foodieLandLogo} />
            </Link>
          ...
          <nav className="mainFooter__nav">
            <ul className="mainFooter__pageOptions">
              <li className="mainFooter__item">
        ...
        <hr className="mainFooter__horizontalLine" />

        <div className="mainFooter__bottomContainer">
          <p className="mainFooter__copyright">
            © 2020 Flowbase. Powered by{" "}
            <span className="mainFooter__highlight">Webflow</span>
          </p>

          <div className="mainFooter__socialMedia">
            <nav className="mainFooter__socialNav">
              <a
              ...
              <a href="https://www.instagram.com/foodieland_te" target="_blank">
                <svg
                  width="23"
                  height="22"
                  viewBox="0 0 23 22"
